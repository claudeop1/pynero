...
class EstimateFeeTest(BitcoinTestFramework):
    ...
    def test_estimatesmartfee_return_mempool_estimates(self):
        ...
        self.log.info("Test persisted mined-block statistics require a restored mempool snapshot")
        # Save matching estimator and mempool snapshots with transactions in the
        # mempool. Reuse them to exercise each way startup can fail to restore the
        # mempool while the persisted estimator window still matches the chain tip.
        ...
        self.log.info("Retain persisted mined-block statistics when only an expired tail is missing")
