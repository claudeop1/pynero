    ...
    bool taproot_keypath_only)
{
    ...
    for (unsigned int i = 0; i < psbtx.inputs.size(); ++i) {
        ...
        const auto sign_result = SignPSBTInput(provider, psbtx, /*index=*/i, &txdata, {
                .sighash_type = sighash_type,
                .finalize = finalize,
                .taproot_keypath_only = taproot_keypath_only}, /*out_sigdata=*/nullptr);
    ...
    return RPCMethod{
        ...
        "Update all segwit inputs in a PSBT with information from output descriptors, the UTXO set or the mempool. \n"
            ...
            "       \"SINGLE|ANYONECANPAY\""},
                    ...
                    {"keypath_only", RPCArg::Type::BOOL, RPCArg::Default{false}, "Only add Taproot key-path data, and only sign and finalize Taproot inputs using the key path. Existing script-path data is not signed or finalized."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
